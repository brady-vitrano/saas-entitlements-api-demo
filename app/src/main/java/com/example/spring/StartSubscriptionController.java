...
/**
 * REST surface for command StartSubscription.
 */
@RestController
public class StartSubscriptionController {

    private final StartSubscriptionService service;


    @Autowired
    public StartSubscriptionController(StartSubscriptionService service) {
        this.service = service;
    }

    @PreAuthorize("hasRole('account-operator')")
    @PostMapping("/api/subscriptions")
    public ResponseEntity<Subscription> handle(@Valid @RequestBody StartSubscriptionRequest request, Authentication authentication) {
