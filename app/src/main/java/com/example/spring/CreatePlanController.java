...
/**
 * REST surface for command CreatePlan.
 */
@RestController
public class CreatePlanController {

    private final CreatePlanService service;


    @Autowired
    public CreatePlanController(CreatePlanService service) {
        this.service = service;
    }

    @PreAuthorize("hasRole('entitlement-admin')")
    @PostMapping("/api/plans")
    public ResponseEntity<Plan> handle(@Valid @RequestBody CreatePlanRequest request, Authentication authentication) {
