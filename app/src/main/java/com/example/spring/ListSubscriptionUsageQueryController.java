...
/**
 * REST surface for query ListSubscriptionUsage.
 */
@RestController
public class ListSubscriptionUsageQueryController {

    private final ListSubscriptionUsageQueryService service;

    @Autowired
    public ListSubscriptionUsageQueryController(ListSubscriptionUsageQueryService service) {
        this.service = service;
    }

    @GetMapping("/api/subscriptions/{subscriptionId}/usage")
    public java.util.List<UsageMeter> handle(
        ...
        return service.handle(new ListSubscriptionUsageQueryRequest(subscriptionId, tenantId));
    }
