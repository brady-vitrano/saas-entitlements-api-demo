...
/**
 * REST surface for query GetFeature.
 */
@RestController
public class GetFeatureQueryController {

    private final GetFeatureQueryService service;

    @Autowired
    public GetFeatureQueryController(GetFeatureQueryService service) {
        this.service = service;
    }

    @GetMapping("/api/features/{featureKey}")
    public Feature handle(
        ...
        return service.handle(new GetFeatureQueryRequest(featureKey, tenantId));
    }
