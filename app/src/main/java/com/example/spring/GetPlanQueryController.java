...
/**
 * REST surface for query GetPlan.
 */
@RestController
public class GetPlanQueryController {

    private final GetPlanQueryService service;

    @Autowired
    public GetPlanQueryController(GetPlanQueryService service) {
    ...
    public Plan handle(
        ...
        return service.handle(new GetPlanQueryRequest(planId, tenantId));
    }
