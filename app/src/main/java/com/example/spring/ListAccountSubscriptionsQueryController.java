...
/**
 * REST surface for query ListAccountSubscriptions.
 */
@RestController
public class ListAccountSubscriptionsQueryController {

    private final ListAccountSubscriptionsQueryService service;

    @Autowired
    public ListAccountSubscriptionsQueryController(ListAccountSubscriptionsQueryService service) {
        this.service = service;
    }

    @GetMapping("/api/accounts/{accountId}/subscriptions")
    public java.util.List<Subscription> handle(
        ...
        return service.handle(new ListAccountSubscriptionsQueryRequest(accountId, tenantId));
    }
