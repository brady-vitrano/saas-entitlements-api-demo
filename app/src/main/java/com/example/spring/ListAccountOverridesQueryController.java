...
/**
 * REST surface for query ListAccountOverrides.
 */
@RestController
public class ListAccountOverridesQueryController {

    private final ListAccountOverridesQueryService service;

    @Autowired
    public ListAccountOverridesQueryController(ListAccountOverridesQueryService service) {
        this.service = service;
    }

    @GetMapping("/api/accounts/{accountId}/overrides")
    public java.util.List<AccountOverride> handle(
        ...
        return service.handle(new ListAccountOverridesQueryRequest(accountId, tenantId));
    }
    ...
    private String authorizationDecisionReceipt(
        ...
        return "{"
                ...
                + "\"target\":\"queries\","
                + "\"operation\":\"ListAccountOverrides\","
