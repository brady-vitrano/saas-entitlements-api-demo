...
/**
 * REST surface for query ListPlanEntitlements.
 */
@RestController
public class ListPlanEntitlementsQueryController {

    private final ListPlanEntitlementsQueryService service;

    @Autowired
    public ListPlanEntitlementsQueryController(ListPlanEntitlementsQueryService service) {
        this.service = service;
    }

    @GetMapping("/api/plans/{planId}/entitlements")
    public java.util.List<Entitlement> handle(
        ...
        return service.handle(new ListPlanEntitlementsQueryRequest(planId, tenantId));
    }
